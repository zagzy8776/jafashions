...
export default function WhatsAppDock() {
  return (
    <a href={whatsappLink()} target="_blank" rel="noreferrer" aria-label={`WhatsApp ${STORE.phoneDisplay}`} className="fixed bottom-5 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#111] text-white">
